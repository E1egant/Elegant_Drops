...
export default function Completos() {
  ...
  useEffect(() => {
    setLoading(true)
    const url = filtro !== 'todos' ? `/api/tienda/completos?filtro=${filtro}` : '/api/tienda/completos'
    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: 1400, margin: '0 auto', padding: '32px 24px 80px' }}>
        ...
        {loading ? (
          ...
          <p style={{ color: 'var(--text-faint)', fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.2em', textAlign: 'center', padding: '64px 0' }}>
            No hay perfumes completos disponibles
          </p>
        ) : (
