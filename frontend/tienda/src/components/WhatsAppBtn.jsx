          ...
          <div style={{
            ...
            {opciones.map((op, i) => (
              <a key={i}
                ...
                <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'rgba(37,211,102,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: 16 }}>
                  💬
                </div>
                <div>
